...
<div class="card">
   ...
   <div class="row">
    ...
    <div class="col-md-3">
        <div class="card mb-3">
            <div class="card-header fw-bold"><img src="https://img.freepik.com/premium-vector/philippines-flag-button-emblem-philippines-vector-flag-symbol-colors-proportion-correctly_847658-222.jpg" style="width: 30px; height: 30px;"> Domestic</div>
