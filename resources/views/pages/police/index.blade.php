    ...
    <div class="modal-content">
      <div class="modal-header">
        <div class="d-flex align-items-center">
            ...
            <h5 class="modal-title" id="disclaimerLabel">City Police Office (CPO)</h5>
        </div>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <div class="d-flex align-items-center">
            ...
            <h5 class="modal-title" id="disclaimerLabel">Provincial Police Office (PPO)</h5>
        </div>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <div class="d-flex align-items-center">
            ...
            <h5 class="modal-title" id="disclaimerLabel">Police Regional Office (PRO)</h5>
        </div>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
    ...
    data.forEach(police => {
        ...
        const popupContent = `
            ...
            <strong>Address:</strong>
                ...
                ${police.sub_city || 'N/A'}
                ${police.city || 'N/A'}
                ${police.provinces_region || 'N/A'}, Philippines<br>
        ...
        marker.addListener('click', () => {
            ...
            const safeName = (police.name_police || '').replace(/'/g, "\\'");
            ...
            if (lastClickedLocation && !isNaN(destLat) && !isNaN(destLng)) {
                actionBtns = `
                    <div style="margin-top:8px;padding-top:8px;border-top:1px solid #eee;display:flex;gap:6px;flex-wrap:wrap;">
                        <button onclick="showRouteOnMap(${lastClickedLocation.lat},${lastClickedLocation.lng},${destLat},${destLng},'${safeName}')"
                           style="display:inline-flex;align-items:center;gap:5px;
                                  background:#1a73e8;color:#fff;border:none;
                                  padding:5px 12px;border-radius:6px;font-size:12px;
                                  font-weight:500;cursor:pointer;">
                ...
                actionBtns = `
                    <div style="margin-top:8px;padding-top:8px;border-top:1px solid #eee;">
                        <a href="${detailUrl}" class="btn btn-primary btn-sm" style="color:white;">Read More</a>
                    </div>`;
            }

            infoWindow.setContent(`<div style="font-size:13px; min-width: 200px;">${popupContent}${actionBtns}</div>`);
            infoWindow.open(map, marker);
        });
