...
Route::get('/redirect-to-wp', function (Illuminate\Http\Request $request) {
    ...
    $allowedTargets = [
        'incident-tracking' => 'https://ph.concordreview.com/incident-tracking-dashboard/',
        'dashboard' => 'https://ph.concordreview.com/indonesia-dashboard-w900/',
    ];
